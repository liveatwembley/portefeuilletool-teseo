...
from core.utils import safe_float as _safe_float, safe_int as _safe_int
...
def sync_ibkr_to_supabase(supabase, token=None, query_id=None):
    ...
    from core.config.tickers import get_currency, get_sector, get_ibkr_symbol_map, TICKERS
